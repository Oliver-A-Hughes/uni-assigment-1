...
public class Q1Calculator 
{
   ...
   {
	// Check that the input is valid, if not display an error message
       if(i <= 0)
       {
           JOptionPane.showMessageDialog(null, "Invalid Input. Integer must be a positive value and greater than zero");
           System.exit( 0 ); 
       }
